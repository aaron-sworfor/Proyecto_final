...
{
	$sql="UPDATE  venta_productos SET id_producto=:idpro, fecha_venta=:fec, cantidad_productos=:can, precio=:prec, nombre_producto= :nomb,id_factura=fact WHERE id_venta=:idv";
	...
	$stmt->bindValue(':fact',$_GET['id_factura']);	
	$stmt->execute();
